		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12" style="height: 100px;">
					<img id="mar" src="./mar.png" style="top: 50px; width: 100px; left: 0px; bottom: 30px; position: absolute;">
					<div id="clock" style="top: 50px; left: 90px; width: 100px; bottom: 60px; font-size: 1em; font-weight: bold; position: absolute;">&nbsp;</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<img id="men" alt="달리는 사람" src="./run2.gif" style="width: 80px; height: 100px; left: 0px; position: absolute;" />
					<!-- float:left; -->
